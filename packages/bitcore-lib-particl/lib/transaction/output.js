...
function Output(args) {
  ...
  if (_.isObject(args)) {
    ...
    if (typeof args.data != 'undefined') {
      if (_.isString(args.data) && JSUtil.isHexa(args.data)) {
        this.data = Buffer.from(args.data, 'hex');
      } else {
        this.data = args.data;
      }
    }
...
Output.prototype.toBufferWriter = function(writer, noWitness, includeType) {
  ...
  if (_.isUndefined(includeType) || includeType == true)
  {
  ...
  switch(this.type)
  {
    ...
    case OUTPUT_TYPES.OUTPUT_CT:
      ...
      if (!noWitness || _.isUndefined(this.rangeproof)) {
