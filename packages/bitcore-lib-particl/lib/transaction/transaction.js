...
Transaction.prototype.fromBuffer = function(buffer, noWitness) {
  var reader = new BufferReader(buffer);
  return this.fromBufferReader(reader, noWitness);
};

Transaction.prototype.fromBufferReader = function(reader, noWitness) {
