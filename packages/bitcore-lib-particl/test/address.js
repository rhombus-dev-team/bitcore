...
describe('Address', function() {
  ...
  var buf = Buffer.concat([new Buffer([0x38]), pubkeyhash]);
  var str = 'PdRLvNdZU3oJkwT8cmvb6svHc5ZKRASmSt';
  ...
  // livenet valid
  var PKHLivenet = [
    'PfLQxr1Ec6WDxXx32HWJCL7ckYHfkc9BvH',
    'PbjEg8jhDoLgDwZD63jfUM1WFWW6JZ9vjZ',
    'Pjxr6q1qiF8KsSR2g3w5at8kF22MEYUYKJ',
    'PhD3NVBw1LiXFLrbEBPQFKi4Z4BG5spTzu',
    '    Pv27D2no3EDon1nmHQeAdVdfuc9EqMLHDQ   \t\n'
  ];

  // livenet p2sh
  var P2SHLivenet = [
    'RNzjqYkMgTkw6qdELEgFCEXfzDYEcPmuYa',
    'RYN3CNZH7J1GRgRwJ8fuCDLNyNnxoxtrGP',
    'RGxC83pewZ4CAiHAr7JRkSgSdjjWrWVGST',
    'RHJp7mkoBPrqSe9XTaNUHC9DxzQxz2ZEgY',
    '\t \nRDEzVdNDF8Tt76bxXezFo2w9srZAWbW7G8 \r'
  ];

  // testnet p2sh
  var P2SHTestnet = [
    'rUnokKd1qieuwoDuwEkUbGBva1ViGUbafV',
    'rB1qw2nRw1BawSHWKrWSLdrLXdKedJ5zSW',
    'rLFWhLGUoSAZr1Dzwyy1Do8nZe7eDn5pJq',
    'rMFJs6GWaS8h4xVyw9sq1yrnQ6yx9GQWDa'
  ];

  //livenet bad checksums
  var badChecksums = [
    'Pa1VtrTYnALPT1mJFBK2K7Xy2GiRxUCXma',
    'Poew53geeNpLAiN5ajd3VazpNFjrQba7Er',
    'PmSs9DFKY9Jm8qM449pH9A7Aib3mZzKSwu',
    'PZUsoUEpk5hhmAueQtkdWKYnfqmm3VYKXa'
  ];

  //livenet non-base58
  var nonBase58 = [
    'Pa1VtrTYnALPT1m#FBK2K7Xy2GiRxUCXma',
    'Poew53geeNpL@iN5ajd3VazpNFjrQba7Er',
    'PmSs9DFKY9Jm8qM44%pH9A7Aib3mZzKSwu',
    'PZUsoUEpk5^hmAueQtkdWKYnfqmm3VYKXa'
  ];

  //testnet valid
  var PKHTestnet = [
    'pjuQ2XtZyUfyU4yPm5SxAFVpki2rubq6s1',
    'pdnYYiHKtN8MjRby9cUtnUHnTgFw6W8g54',
    'pgu8RyxWdW9sjTziqwmz3GzUPxmESUhmcP',
    'paqozghXZHiLfDK7BpVopgomw9RmDeLKQ8'
  ];

  describe('validation', function() {

    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('RNzjqYkMgTkw6qdELEgFCEXfzDYEcPmuYa', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('RNzjqYkMgTkw6qdELEgFCEXfzDYEcPmuYa', 'livenet');
      valid.should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      var valid = Address.isValid('RNzjqYkMgTkw6qdELEgFCEXfzDYEcPmuYa', 'testnet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n PsqDdLYNnGWctgdh6D2Lr1FstW1yEeiTDk \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('PsqDdLYNnGWctgdh6D2Lr1FstW1yEeiTDk');
    });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('Pgc4DzPyJCAPfAZKTb3iiQictEtSnWrho3');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('PdEJvnes4af2UFkvLavv2Gs26wJxZp8sbc');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('PdEJvnes4af2UFkvLavv2Gs26wJxZp8sbc');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('PrEvx4kj1P5fp9uC9DLYSc3VUXNs84uhH8');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('PrEvx4kj1P5fp9uC9DLYSc3VUXNs84uhH8');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('RQVpWkVhxRyrPJ2psPVnuVArt67JYcXLye');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('RQVpWkVhxRyrPJ2psPVnuVArt67JYcXLye');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'PeF1dhefWwL5CCqf1vkWfBrHdFEb8CyqBb';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'RViGSUd6BsZ7mqK3rwBFUv2GGfLZcFjqoT';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash PdRLvNdZU3oJkwT8cmvb6svHc5ZKRASmSt', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: PdRLvNdZU3oJkwT8cmvb6svHc5ZKRASmSt, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('RPV1YQ7hkKR3dxSFpX5WMsXM6ey3bJ4v4K');
    ...
    it('works on testnet also', function() {
      ...
      address.toString().should.equal('rLSQb8bZmW9NLq5dLXjGReQ87vwXk2A4TB');
    });
    ...
    it('can create an address from a set of public keys with a nested witness program', function() {
      ...
      address.toString().should.equal('RXQVAZagXgsW2EmAjWnqn5NiAkPEcnNeqF');
    });
