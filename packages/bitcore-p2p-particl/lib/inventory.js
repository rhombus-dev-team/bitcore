...
Inventory.forFilteredBlock = function(hash) {
  return Inventory.forItem(Inventory.TYPE.WITNESS_FILTERED_BLOCK, hash);
};
...
Inventory.TYPE.WITNESS_TX = Inventory.TYPE.TX | WITNESS_FLAG
Inventory.TYPE.WITNESS_BLOCK = Inventory.TYPE.BLOCK | WITNESS_FLAG
Inventory.TYPE.WITNESS_FILTERED_BLOCK = Inventory.TYPE.FILTERED_BLOCK | WITNESS_FLAG
Inventory.TYPE_NAME = [
  'ERROR',
  'TX',
  'BLOCK',
